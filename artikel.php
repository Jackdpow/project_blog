            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text"><strong>User ID:</strong> <?php echo $row['user_id']; ?></p>
                        <p class="card-text"><strong>Status:</strong> <?php echo $row['status_aktif'] ? 'Aktif' : 'Tidak Aktif'; ?></p>
                    </div>
                    <div class="card-footer">
                        <div class="d-flex justify-content-between">
                            <a href="edit_artikel.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">Edit</a>
                            <form action="delete_artikel.php" method="POST" class="d-inline">
